...
y_inloc = [0, 0.35, 0.59, 0.68, 0.75, 0.82,  0.89, 0.92, 0.935]
y_GSPV =  [0, 0.42, 0.65, 0.74, 0.82, 0.86,  0.91, 0.938, 0.945]
y_HAIL =  [0, 0.29, 0.46, 0.58, 0.65, 0.71, 0.79,  0.83,  0.842]
y_efiloc= [0, 0.33, 0.53, 0.67, 0.78, 0.83, 0.87, 0.90, 0.912]
y_efilocpv=[0, 0.41,0.66, 0.75, 0.806,0.868, 0.923, 0.935, 0.938]
# for line in file:
#     if line != "\n":
#         data.append(line)
# print(len(data))
...
plt.savefig("viewpoint-LOC.png", dpi = 500)
plt.show()
