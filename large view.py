...
y_inloc = [0, 0.324, 0.56, 0.652, 0.735, 0.788,  0.829, 0.838, 0.845]
y_GSPV =  [0, 0.342, 0.573, 0.692, 0.777, 0.826,  0.855, 0.884, 0.901]

y_HAIL =  [0, 0.315, 0.48, 0.61, 0.675, 0.7, 0.712,  0.719,  0.7235]

y_efiloc= [0, 0.33, 0.5365, 0.635, 0.715, 0.763, 0.795, 0.815, 0.83]
y_efilocpv=[0, 0.352,0.586, 0.715, 0.792,0.818, 0.843, 0.861, 0.8735]
# for line in file:
#     if line != "\n":
#         data.append(line)
# print(len(data))
...
plt.grid()  #生成网格
plt.title("Large view", fontsize=16)  # 标题
...
plt.savefig("Largeview-LOC.png", dpi = 500)
plt.show()
